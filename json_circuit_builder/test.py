...
from json_circuit_builder.components import *
...
# File save
output_path = Path(__file__).resolve().parent / "outputs" / "Hydro_Container_Circuit_generated.json"
output_path.parent.mkdir(parents=True, exist_ok=True)
with output_path.open("w") as f:
    json.dump(hyd_circuit.to_dict(), f, indent=2)